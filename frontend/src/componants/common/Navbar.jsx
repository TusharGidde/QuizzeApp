...
import { useTheme } from "../../context/TheamContext"; // ✅ Correct spelling
...
const Navbar = () => {
  ...
  return (
    <nav className="w-full px-6 py-4 bg-white dark:bg-gray-900 shadow-md flex justify-between items-center border-b shadow-gray-200 dark:shadow-gray-700">
      {/* Logo / App Name */}
      <Link
        to="/"
